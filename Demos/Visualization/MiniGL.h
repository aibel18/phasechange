...
namespace PBD
{
	...
	public:
		...
		static void reziseDesWidth();
		static void reziseDesHeight();

		static void MiniGL::timedDisplay(int n);
		...
		static void saveFrame(char *prefix, int test_id,float frame_id, unsigned int color_max, unsigned int pixel_nbytes);
